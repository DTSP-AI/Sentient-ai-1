...
function No(e, t = {}) {
  var n;
  _.setLevel(e), Fn((n = t.liveKitClientLogLevel) != null ? n : e);
}
function $o(e, t = {}) {
  var n;
  ...
  }, _.setLevel(_.getLevel()), jn((n = t.liveKitClientLogExtension) != null ? n : e);
}
var Uo = [
  {
    columns: 1,
...
function Ho(e) {
  ...
  const n = t.find((r) => r instanceof ot);
  if (n) {
    const r = t.indexOf(n);
...
function qo(e, t) {
  return ae(e, b.ParticipantEncryptionStatusChanged).pipe(
    ...
    k(([n]) => n),
    M(
      t instanceof ot ? t.isE2EEEnabled : !!(t != null && t.isEncrypted)
    )
  );
}
function Xo(e) {
...
function ps(e, t) {
  ...
  const i = new re(), o = () => {
    var T, x, I;
    return ((T = e.serverInfo) == null ? void 0 : T.edition) === 1 || !!((x = e.serverInfo) != null && x.version) && Wn((I = e.serverInfo) == null ? void 0 : I.version, "1.17.2") > 0;
...
function xs(e) {
  return Ln(e, Ft.TranscriptionReceived);
}
function Es(e) {
  return Ln(e, Ft.TimeSyncUpdate).pipe(
    k(([t]) => t)
  );
}
function Ts(e, t = 1e3) {
...
const Dn = D.createContext(void 0);
function As() {
...
function Os() {
  const [e, t] = D.useReducer(In, Tn), [n, r] = D.useReducer(_n, Cn);
  return {
...
function Ls(e) {
  const [t, n] = D.useReducer(In, Tn), [r, i] = D.useReducer(_n, Cn);
  return e ?? {
...
const $n = D.createContext(void 0);
function Rs() {
...
const Co = D.createContext(void 0);
function $s(e) {
...
//# sourceMappingURL=contexts-BggYqn0S.mjs.map
